...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://project-setup-template/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _UI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UI */ \"./src/UI.js\");\n\n\n\nfunction upperCase(string) {\n  const str = string;\n  const modStr = str[0].toUpperCase() + str.slice(1);\n  return modStr;\n}\n\nconst getWeatherData = async (userLocation) => {\n  const location = upperCase(userLocation);\n  try {\n    const response = await fetch(\n      `https://api.weatherapi.com/v1/current.json?key=490370ad19b74d52b78123129233011&q=${location}`,\n      { mode: \"cors\" },\n    );\n    const weatherData = await response.json();\n    if (\n      weatherData.location.name === location ||\n      weatherData.location.region === location ||\n      weatherData.location.country === location\n    ) {\n      const error = document.getElementById(\"error\");\n      error.style.display = \"none\";\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].changeLocation(location);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].temperature(weatherData.current.temp_c);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].sky(weatherData.current.condition.text);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].feelsLike(weatherData.current.feelslike_c);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].humidity(weatherData.current.humidity);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].wind(weatherData.current.wind_kph);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].date(weatherData.location.localtime);\n      _UI__WEBPACK_IMPORTED_MODULE_1__[\"default\"].time(weatherData.location.localtime);\n    }\n  } catch (err) {\n    const error = document.getElementById(\"error\");\n    error.style.display = \"block\";\n  }\n};\n\nfunction getUserLocation() {\n  const location = document.getElementById(\"location\");\n  location.addEventListener(\"keydown\", (e) => {\n    if (e.key === \"Enter\") {\n      e.preventDefault();\n      getWeatherData(location.value);\n    }\n  });\n}\n\ngetUserLocation();\ngetWeatherData(\"manila\");\n\n\n//# sourceURL=webpack://project-setup-template/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"2828b44aeeee492d1311.jpeg\";\n\n//# sourceURL=webpack://project-setup-template/./src/clear-sky.jpeg?");
...
eval("module.exports = __webpack_require__.p + \"d366dfa41707634ff4b4.svg\";\n\n//# sourceURL=webpack://project-setup-template/./src/location-pin-svgrepo-com_(1).svg?");
